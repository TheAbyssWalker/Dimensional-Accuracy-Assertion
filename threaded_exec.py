...
def process(bolt_image):
    ...
    if valley_row.size > peak_row.size:
        valley_row = valley_row[: peak_row.size - removeLastElements]
        valley_col = valley_col[: peak_row.size - removeLastElements]
        peak_row = peak_row[: peak_row.size - removeLastElements]
        peak_col = peak_col[: peak_col.size - removeLastElements]
    else:
        peak_row = peak_row[: valley_row.size - removeLastElements]
        peak_col = peak_col[: valley_row.size - removeLastElements]
        valley_row = valley_row[: valley_row.size - removeLastElements]
        valley_col = valley_col[: valley_row.size - removeLastElements]
